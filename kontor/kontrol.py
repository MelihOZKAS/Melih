...
def AlternatifKontrol(request):
    ...
    for siparis in siparisler:
        ...
        try:
            ...
            if siparis.SorguPaketID == "VodafoneDegilKi,GNC001" or siparis.SorguPaketID == "VergiBorcuÇokTLYüklemesiLazım" or siparis.SorguPaketID == "VodafoneDegilKi" or siparis.SorguPaketID == "TurkcellDegil" or siparis.SorguPaketID == "TurkcellDegil,GNC001" or siparis.SorguPaketID == "HatFaturali!" or siparis.SorguPaketID == "AveaDegil!" or siparis.SorguPaketID == "NumaraEksik!" or siparis.SorguPaketID == "GirmişolduğunuznumaraTurkcell’denhizmetalmamaktadır." or siparis.SorguPaketID == "AveaDeğilyadaBirikmişVergiBorcuVardırÖnceTLYüklemesiGerekir!":
